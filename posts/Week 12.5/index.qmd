...
##### Logic: Old item types with close to 1 mean echo cue similarity with close to 1 mean global activation: each of those items was in the memory system at least one time so should expect at least one item to be strongly activated
